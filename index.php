...
if (isStudent()) {
    $stmt = $pdo->prepare("
        SELECT c.*, e.enrolled_at,
               ...
               (SELECT COUNT(*) FROM module_completions mc INNER JOIN course_modules cm2 ON cm2.id = mc.module_id WHERE cm2.course_id = c.id AND mc.student_id = ?) AS done_modules
        FROM courses c
